    ...
    public function run(): void
    {
        ...
        $questionPapers = [
            [
                ...
                'file_path' => 'question_papers/cs_midterm_2024.pdf',
                'course_code' => 'CSE101',
                'semester' => 3,
            ...
            [
                ...
                'file_path' => 'question_papers/cs_final_2023.pdf',
                'course_code' => 'CSE101',
                'semester' => 4,
            ...
            [
                ...
                'year' => 2024,
                'exam_type' => 'midterm', // Changed from 'Mid-Term' to match enum
                'file_path' => 'question_papers/ece_midterm_2024.pdf',
                'course_code' => 'ECE201',
                'semester' => 2,
            ...
            [
                ...
                'year' => 2023,
                'exam_type' => 'final', // Changed from 'Final' to match enum
                'file_path' => 'question_papers/ece_final_2023.pdf',
                'course_code' => 'ECE201',
                'semester' => 3,
            ...
            [
                ...
                'year' => 2024,
                'exam_type' => 'other', // Changed from 'Quiz' to match enum
                'file_path' => 'question_papers/me_quiz_2024.pdf',
                'course_code' => 'ME301',
                'semester' => 4,
            ...
            [
                ...
                'year' => 2023,
                'exam_type' => 'final', // Changed from 'Final' to match enum
                'file_path' => 'question_papers/bba_final_2023.pdf',
                'course_code' => 'BBA101',
                'semester' => 1,
            ...
            [
                ...
                'year' => 2024,
                'exam_type' => 'midterm', // Changed from 'Mid-Term' to match enum
                'file_path' => 'question_papers/math_midterm_2024.pdf',
                'course_code' => 'MATH201',
                'semester' => 2,
            ...
            [
                ...
                'file_path' => 'question_papers/cs_supp_2024.pdf',
                'course_code' => 'CSE101',
                'semester' => 1,
